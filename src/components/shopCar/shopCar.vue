    ...
    <div class="content" @click="toggleList">
      <div class="left">
        <div class="logo-wrapper">
          ...
          <div class="bubble-wrapper" v-if="foodCount > 0">
      ...
      <div class="right" :class="{'hightlight':payPrice=='结算'}" @click="pay">
        <span v-text="payPrice" class="dispatching"></span>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    //隐藏购物车列表
    _hideShopList(){
      const comp = this.sticky ? this.$parent.list : this.shopListComp
      comp.hide && comp.hide()
    },
    //显示购物车层级组件
    _showShopSticky(){  
